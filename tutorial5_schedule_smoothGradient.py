...
### First we observe the default ordering.
    ...
    print "Default Realization took: ", end - start
...
# Putting it all together.
    ...
    # Since this is a single-stage pipeline with little computation, don't 
    # expect a huge speedup. But it illustrates in a simple context the type 
    # of reorganizations that are needed for complex image processing
    ...
    end2 = time()
    print "Fast Realization took ", end2 - start2
